...
class KTextTheme {
  KTextTheme._(); // avoid instance creation

  static TextTheme lightTextTheme = TextTheme(
    headline1: GoogleFonts.montserrat(
        fontSize: 28.0, fontWeight: FontWeight.bold, color: DarkColor),
    headline2: GoogleFonts.montserrat(
        fontSize: 22.0, fontWeight: FontWeight.w700, color: DarkColor),
    headline3: GoogleFonts.poppins(
        fontSize: 24.0, fontWeight: FontWeight.w700, color: DarkColor),
    headline4: GoogleFonts.poppins(
        fontSize: 20.0, fontWeight: FontWeight.w700, color: DarkColor),
    ...
    bodyText2: GoogleFonts.poppins(
        fontSize: 12.0, fontWeight: FontWeight.normal, color: DarkColor),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headline3: GoogleFonts.poppins(
        fontSize: 24.0, fontWeight: FontWeight.w700, color: WhiteColor),
    headline4: GoogleFonts.poppins(
        fontSize: 20.0, fontWeight: FontWeight.w700, color: WhiteColor),
    headline5: GoogleFonts.poppins(
    ...
    bodyText2: GoogleFonts.poppins(
        fontSize: 12.0, fontWeight: FontWeight.normal, color: WhiteColor),
  );
}
